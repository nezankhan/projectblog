...
SECRET_KEY = 'django-insecure-8ltp=_!gp9mn7og08^x(kxfc-vtbx_0bg_9j=2n5&a%#!4io)5'
...
STATIC_URL = 'static/'
MEDIA_ROOT = os.path.join(BASE_DIR,'media') #uploaded images where it will be stored
